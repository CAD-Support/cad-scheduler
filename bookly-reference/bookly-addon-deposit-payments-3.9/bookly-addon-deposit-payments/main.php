...
/*
Plugin Name: Bookly Deposit Payments (Add-on)
Plugin URI: https://www.booking-wp-plugin.com/?utm_source=bookly_admin&utm_medium=plugins_page&utm_campaign=plugins_page
Description: Bookly Deposit Payments add-on allows you to set up a minimum amount that has to be paid at the time of booking.
Version: 3.9
Author: Nota-Info
...
if ( ! file_exists( $addon ) || $addon === __DIR__ ) {
    ...
    BooklyDepositPayments\Lib\Boot::up();
}