<?php
namespace BooklyEvents\Lib\Base;
...
abstract class Installer
{
    ...
    public function loadData()
    {
        ...
        add_option( $plugin_prefix . 'purchase_code', '' );
        ...
        foreach ( $this->notifications as $data ) {
            $notification = new \Bookly\Lib\Entities\Notification();
    ...
    public function removeData()
    {
        ...
        delete_option( $plugin_prefix . 'purchase_code' );
    }
