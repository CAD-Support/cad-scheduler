...
<div class="bookly-box bookly-list">
    ...
    <button class="bookly-btn ladda-button bookly-js-apply-tips" data-style="zoom-in" data-spinner-size="40" style="<?php if ( $userData->getTips() > 0 ) : ?>display: none;<?php else : ?>display: inline-block;<?php endif ?>">
    ...
    <button class="bookly-btn ladda-button bookly-js-applied-tips" style="<?php if ( $userData->getTips() == 0 ) : ?>display: none;<?php else : ?>display: inline-block;<?php endif ?>">
        <span class="ladda-label"><?php echo BooklyLib\Utils\Common::getTranslatedOption( 'bookly_l10n_button_applied_tips' ) ?></span>
    </button>
